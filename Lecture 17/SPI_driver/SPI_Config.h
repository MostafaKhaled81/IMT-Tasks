...
#define  SPI1_ClkPolarity  IDLE_IN0
...
#define  SPI1_NoOfFrameBits  SPI_16bit
#define  SPI2_NoOfFrameBits  SPI_16bit
#define  SPI3_NoOfFrameBits  SPI_16bit
#define  SPI4_NoOfFrameBits  SPI_16bit
