...
void GPIO_voidSetPortValue(port_index_t Copy_PortIndex, u32 GPIOLogic);
...
void GPIO_voidSetAlternativeFunction(port_index_t Copy_PortIndex,
                                     pin_index_t Copy_PinIndex,
									 u8 Copy_AlternativeFuncNO);
#endif
